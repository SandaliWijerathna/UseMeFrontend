...
class shopReg extends React.Component {
    constructor() {
      super();
      this.state = {
        fields: {},
    ...
    validateForm() {
      ...
      if (!fields["shop"]) {
        formIsValid = false;
        errors["shop"] = "*Please enter your username.";
      }

      if (typeof fields["shop"] !== "undefined") {
        if (!fields["shop"].match(/^[a-zA-Z ]*$/)) {
          formIsValid = false;
          errors["shop"] = "*Please enter alphabet characters only.";
        }
      }
      ...
      if (!fields["brtnumber"]) {
        formIsValid = false;
        errors["brnumber"] = "*Please enter your Business Registration number.";
      }

      if (typeof fields["brnumber"] !== "undefined") {
        if (!fields["brnumber"].match(/^[0-9]{10}$/)) {
          formIsValid = false;
          errors["brnumber"] = "*Please enter valid Business Registration number.";
        }
      }
    ...
    <div id="main-registration-container">
     <div id="register">
       ...
       <label>Business Registration Number</label>
        <input type="text" name="brnumber" value={this.state.fields.brnumber} onChange={this.handleChange} />
        <div className="errorMsg">{this.state.errors.brnumber}</div>
